...
export default function Home() {
  ...
  // sends the suggestion to the database
  ...
  // "status === "unauthenticated"" is on all pages to kick the user back to login if they're not already logged in
  return status === "unauthenticated" ? (
    ...
    <main className="w-screen h-screen bg-[#383838] flex flex-row">
      ...
      <div className="flex w-full h-full justify-around items-center">
        ...
        {/* input fields for the activity suggestion */}
